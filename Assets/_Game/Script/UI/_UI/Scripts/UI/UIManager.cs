...
public class UIManager : Singleton<UIManager>
{
    ...
    [HideInInspector] public UpgradeCanvas upgradeCanvas;

    #region Add
    public async Task TransitionUI<TOpen, TClose>(float delay, System.Action action = null, CancellationToken cancellationToken = default)
        ...
        where TClose : UICanvas
    {
        ...
        {
            Debug.Log("TransitionUIAsync was canceled");
        }
    }
